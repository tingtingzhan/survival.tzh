...
#' 
#' @details 
#' The function [date_time_()] is useful as clinicians may put date and time in different columns.
#' 
#' @returns 
#' The function [date_time_()] returns a \link[base]{POSIXct} object.
#' 
#' @examples
#' (today = Sys.Date())
...
#' 
#' @returns 
#' The function [date_difftime_] returns a \link[base]{POSIXct} object.
#' 
#' @note
